...
<style>
	...
	.snd__spacing {
		padding: 170px 310px 290px 310px;
	}
	.subtlt__snd {
		font-size: 20px;
		margin-top: 20px;
	...
	.image_peopleContainer {
		...
		box-shadow: 0px 0px 0px 3px #91abff;
	}
	.testi__context {
...
<style>
	...
	@media (max-width: 1182px) {
		.snd__spacing {
			padding: 170px 210px 290px 210px;
		}
		.title__fthCpn {
	...
	@media (max-width: 999px) {
		.snd__spacing {
			padding: 170px 110px 290px 110px;
		}
		.title__fthCpn {
